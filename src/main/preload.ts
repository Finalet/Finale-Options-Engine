...
import { GetSpreadArgs, GetSpreadOnDateArgs, RunScreenerResultsArgs } from './API/Spreads';
...
const API = {
  spreads: {
    ...
    GetSpreadOnDate: (args: GetSpreadOnDateArgs): Promise<CallCreditSpread> => ipcRenderer.invoke('GetSpreadOnDate', args),
  },
  trades: {
